 ...
 * @author zhangliang
 */
public abstract class AbstractUnsupportedOperationPreparedStatement extends WrapperStatement implements PreparedStatement {
    
    protected AbstractUnsupportedOperationPreparedStatement(final WrapperConnection connection, final int resultSetType, final int resultSetConcurrency, final int resultSetHoldability) {
