...
import com.boddi.multidatasource.util.ParameterList;
...
public abstract class AbstractPreparedStatementAdapter extends AbstractUnsupportedOperationPreparedStatement {
    ...
    protected AbstractPreparedStatementAdapter(final WrapperConnection connection, final int resultSetType, final int resultSetConcurrency, final int resultSetHoldability) {
